    ...
    public class SoundManager : MonoBehaviour
    {
        ...
        protected float sfxVolume 
        {
            ...
            private set
            {
                ...
                this.isMutedSFX = value.Equals(0.0f);
            }
        } float _sfxVolume;
        ...
        {   
            ...
            private set
            {
                ...
                this.isMutedMusic = value.Equals(0.0f);
            }
        } float _musicVolume;
        ...
        public bool IsMutedMusic => this.isMutedMusic;
        protected bool isMutedMusic
        {
            get
            {
            ...
            private set
            {
                ...
                CommonEvents.ON_MUSIC_MUTED?.Invoke(value);
            }
        } private bool _isMutedMusic = false;
        public bool IsMutedSFX => this.isMutedSFX;
        protected bool isMutedSFX
        {
            get 
            {
            ...
            set
            {
                ...
                CommonEvents.ON_SFX_MUTED?.Invoke(value);
            }
        } private bool _isMutedSFX;
        ...
        {
            return PlaySound(sfxData, this.sfxVolume);
        }
        ...
        {
            volume = volume < 0 ? this.sfxVolume : volume;
            AudioSource sfxAudioSrc;
        ...
        {
            volume = volume < 0 ? this.musicVolume : volume;
        ...
        {
            var isMute = !this.isMutedMusic;
            SetMusicMute(isMute);
        }
        public void ToggleSFXMute()
        {
            var isMute = !this.isMutedSFX;
            SetSFXMute(isMute);
        }
